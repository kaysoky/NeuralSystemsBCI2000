                                       ...
                                       SignalProperties& outSignalProperties ) const
{
    ...
    if( Parameter("SignalType") != SignalType::float32 ){
        bcierr <<"Signal Type needs to be float32: " << SignalType::float32 << endl;
    }
    ...
    try{
        int reqChannels = Parameter("SoftwareCh");
    ...
    if( Parameter("SoftwareCh") > _biosemi.getNumChannels() ){
    ...
    outSignalProperties = SignalProperties(
        Parameter( "SoftwareCh" ), Parameter( "SampleBlockSize" ),
            SignalType::float32);
}
...
void Biosemi2ADC::Initialize()
{
    ...
    _softwareCh = Parameter("SoftwareCh");
