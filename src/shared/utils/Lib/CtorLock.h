...
// $END_BCI2000_LICENSE$
///////////////////////////////////////////////////////////////////////
#ifndef TINY_CTOR_LOCK_H
#define TINY_CTOR_LOCK_H
...
public:
  ...
  { Assert( sInstanceInCtor != 0 ); return sInstanceInCtor; }

private:
  static void Lock( T* t )
  {
    sMutex.Acquire();
    Assert( sInstanceInCtor == 0 );
    sInstanceInCtor = t;
  }
  static void Unlock()
  {
...
template<class T> Mutex CtorLock<T>::sMutex;
