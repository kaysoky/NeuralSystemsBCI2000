...
// $END_BCI2000_LICENSE$
///////////////////////////////////////////////////////////////////////
#ifndef TINY_THREADED_SOCKBUF_H
#define TINY_THREADED_SOCKBUF_H
...
class ThreadedSockbuf : public sockbuf
{
 public:
  ...
  const Waitable& NotifyReceived() const
 ...
 private:
  ...
  Lockable<Mutex> mPutLock, mGetLock;
  int mResponseTimeMs;
};

} // namespace

using Tiny::ThreadedSockbuf;

#endif // TINY_THREADED_SOCKBUF_H
