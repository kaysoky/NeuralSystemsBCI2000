...
inline int32_t
bci::Atomic_::Increment( volatile int32_t& v )
{
  return InterlockedIncrement( ATOMIC_PTR_(v) );
}

inline int32_t
bci::Atomic_::Decrement( volatile int32_t& v )
{
  return InterlockedDecrement( ATOMIC_PTR_(v) );
}

inline int32_t
bci::Atomic_::Add( volatile int32_t& v, int32_t a )
{
  return ExchangeAdd( v, a ) + a;
}

inline int32_t
bci::Atomic_::And( volatile int32_t& v, int32_t a )
{
  return ExchangeAnd( v, a ) & a;
}

inline int32_t
bci::Atomic_::Or( volatile int32_t& v, int32_t a )
{
  return ExchangeOr( v, a ) | a;
}

inline int32_t
bci::Atomic_::Exchange( volatile int32_t& v, int32_t x )
{
  return InterlockedExchange( ATOMIC_PTR_(v), x );
}

inline int32_t
bci::Atomic_::ExchangeAdd( volatile int32_t& v, int32_t a )
{
  return InterlockedExchangeAdd( ATOMIC_PTR_(v), a );
}

inline int32_t
bci::Atomic_::ExchangeAnd( volatile int32_t& v, int32_t a )
{
  return _InterlockedAnd( ATOMIC_PTR_(v), a );
}

inline int32_t
bci::Atomic_::ExchangeOr( volatile int32_t& v, int32_t a )
{
  return _InterlockedOr( ATOMIC_PTR_(v), a );
}

inline int32_t
bci::Atomic_::CompareExchange( volatile int32_t& v, int32_t x, int32_t comparand )
{
  return InterlockedCompareExchange( ATOMIC_PTR_(v), x, comparand );
}

inline void*
bci::Atomic_::Exchange( void* volatile& v, void* x )
{
  return InterlockedExchangePointer( (void**)&v, x );
}

inline void*
bci::Atomic_::CompareExchange( void* volatile& v, void* x, void* comparand )
{
  return InterlockedCompareExchangePointer( &v, x, comparand );
}
