...
#ifndef FIRStatFilterH
#define FIRStatFilterH
//---------------------------------------------------------------------------
...
class FIRStatFilter : public GenericFilter
{
private:
       NormalFilter* nf;
...
public:
       FIRStatFilter();
  virtual ~FIRStatFilter();
  virtual void Resting( void );
  virtual void Preflight( const SignalProperties&, SignalProperties& ) const;
  virtual void Initialize();
  virtual void Process( const GenericSignal *SignalE,
