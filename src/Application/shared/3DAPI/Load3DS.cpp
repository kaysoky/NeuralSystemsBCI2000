...
//------- 3DS FILE NAME TO LOAD -------//
string FILE_NAME = "face.3ds";
...
void Load3dsFile(t3DModel &g_3DModel)
{
        /***************************LOAD 3DS FILE******************************/
	...
	// our t3DModel structure and the file name string we want to load ("face.3ds").
        ...
        g_Load3ds.Import3DS(&g_3DModel, FILE_NAME.c_str());			// Load our .3DS file into our model structure
        ...
        for(int i = 0; i < g_3DModel.numOfMaterials; i++)
	{
		...
		if(strlen(g_3DModel.pMaterials[i].strFile) > 0)
		{
			...
			Create3dsTexture(g_Texture, g_3DModel.pMaterials[i].strFile, i);
		}
