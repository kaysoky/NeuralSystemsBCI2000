...
ADD_CUSTOM_COMMAND(
   TARGET "ZERO_CHECK"
   POST_BUILD
   COMMAND ${CMAKE_COMMAND} -E copy "${BCI2000_EXTENSION_DIR}/extlib/dylib/tet.dll" "${BCI2000_ROOT_DIR}/prog"
)

ADD_CUSTOM_COMMAND(
   TARGET "ZERO_CHECK"
   POST_BUILD
   COMMAND ${CMAKE_COMMAND} -E copy "${BCI2000_EXTENSION_DIR}/extlib/dylib/ttime.dll" "${BCI2000_ROOT_DIR}/prog"
)