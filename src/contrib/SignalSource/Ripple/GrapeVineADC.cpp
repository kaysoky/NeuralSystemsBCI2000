...
{
    if (Parameter("SamplingRate")==200) bciout << "Verify Grapevine set to deliver 200 Samples/Sec" << endl;
    else if (Parameter("SamplingRate")==500)  bciout << "Verify Grapevine set to deliver 500 Samples/Sec"  << endl;
    else if (Parameter("SamplingRate")==1000) bciout << "Verify Grapevine set to deliver 1000 Samples/Sec" << endl;
    else if (Parameter("SamplingRate")==2000) bciout << "Verify Grapevine set to deliver 2000 Samples/Sec" << endl;
