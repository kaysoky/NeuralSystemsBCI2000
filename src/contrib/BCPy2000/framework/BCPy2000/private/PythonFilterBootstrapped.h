//   $Id: PythonFilter.h 3638 2011-11-04 00:03:43Z jhill $
//
...
class FILTER_NAME : public FILTER_SUPERCLASS
{
	...
	private:
		PrecisionTime* mTimer;
		PyObject*      mSelf;
		bool           mUseConsole;

		mutable bool           mStayOpen;
		mutable PyThreadState* mSavedThreadState;

		PyArrayObject* mSharedInputSignal;
		PyArrayObject* mSharedOutputSignal;
		double*        mSharedStateValues;
		double*        mSharedFlag;
