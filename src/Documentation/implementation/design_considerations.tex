...
\todo{Is this section still useful? Should it be updated to more current hardware?}
...
\begin{figure}[ht]
 \centerline{\scalebox{0.66}{\includegraphics{figures/performance}}}
