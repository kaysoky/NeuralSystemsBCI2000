...
\begin{figure}[ht]
 \centerline{\scalebox{0.45}{\includegraphics{figures/WBS.eps}}}
...
\begin{figure}[ht]
 \centerline{\scalebox{0.75}{\includegraphics{figures/operator_prot_visualization.eps}}}
 \caption{One message in the protocol, if it is of type "visualization data"}
 \label{visualizationprotocol}
\end{figure}

\begin{figure}[ht]
 \centerline{\scalebox{0.75}{\includegraphics{figures/operator_prot_visualization_type1.eps}}}
...
\begin{figure}[ht]
 \centerline{\scalebox{0.75}{\includegraphics{figures/operator_prot_visualization_type2.eps}}}
...
\begin{figure}[ht]
 \centerline{\scalebox{0.75}{\includegraphics{figures/operator_prot_visualization_type255.eps}}}
