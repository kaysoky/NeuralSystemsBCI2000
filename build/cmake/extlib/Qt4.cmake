# Find Qt 4 module, modified for BCI2000 by juergen.mellinger@uni-tuebingen.de
# Changes are marked with comments including "bci2000"
...
SET(QT_USE_FILE "${_qt4_current_dir}/UseQt4.cmake")
...
# message(STATUS "QT_${basename}_LIBRARY: ${QT_${basename}_LIBRARY}")
  ...
  IF( QT_LIBRARY_DIR AND QT_INCLUDE_DIR AND QT_MOC_EXECUTABLE AND 
    ...
    # bci2000
    FIND_PACKAGE_MESSAGE(Qt4 "Found Qt-Version ${QTVERSION} in BCI2000 source tree"
