...
ELSE( WIN32 )
  ...
  SET( MATLAB_LIBDIRS ${CMAKE_MATCH_2} )
  STRING( REPLACE ":" ";" MATLAB_LIBDIRS ${MATLAB_LIBDIRS} )

  FIND_LIBRARY( MATLAB_MEX_LIBRARY mex ${MATLAB_LIBDIRS} )
  FIND_LIBRARY( MATLAB_MX_LIBRARY mx ${MATLAB_LIBDIRS} )
  FIND_LIBRARY( MATLAB_ENG_LIBRARY eng ${MATLAB_LIBDIRS} )
  SET( LIBS_EXTLIB
    ${MATLAB_MEX_LIBRARY}
    ${MATLAB_MX_LIBRARY}
    ${MATLAB_ENG_LIBRARY}
